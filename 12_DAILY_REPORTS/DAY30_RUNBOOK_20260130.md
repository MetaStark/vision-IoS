...
| Governance | **4/10** | 17/249 tabeller har data, EC-register mangler kjerne-kontrakter |
| Finansiell sporing | **1/10 → 3/10** | capital_ledger populert med 8 CLOSED shadow trades (Aksjon 1 utført) |
| Skjema-hygiene | **3/10** | 903/985 tabeller (92%) er tomme |
...
| **P1** | EC-register mangler kjerne-kontrakter | EC-003 (STIG), EC-001 (LARS), EC-002 (VEGA) ikke registrert. Krever G4. |
...
| 2 | Registrer EC-001/002/003 i ec_registry | P1 | G4-godkjenning |
...
**Last Updated:** 2026-01-30 23:43 CET
**Author:** STIG (CTO)
