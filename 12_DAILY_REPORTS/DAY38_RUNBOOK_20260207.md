...
| Daemon | Interval | Task Name | Next Run | Cycle 1 | Cycle 2 |
|--------|----------|-----------|----------|---------|---------|
| autonomy_clock_tick | 30m | FHQ_AUTONOMY_CLOCK_TICK | 19:57 | ⏳ | ⏳ |
| promotion_gate_engine | 60m | FHQ_PROMOTION_GATE_PULSE | 19:00 | ⏳ | ⏳ |
| shadow_trade_creator | 15m | FHQ_SHADOW_TRADE_CREATOR | 19:56 | ⏳ | ⏳ |
| shadow_trade_exit_engine | 15m | FHQ_SHADOW_TRADE_EXIT_ENGINE | 19:56 | ⏳ | ⏳ |
...
**Monitoring:** Awaiting 2 consecutive scheduled cycles per daemon (no manual runs).
