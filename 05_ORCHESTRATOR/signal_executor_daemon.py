...
Canonical implementation : 03_FUNCTIONS/signal_executor_daemon.py
...
05_ORCHESTRATOR/signal_executor_daemon.py keeps working, while exactly ONE implementation exists.
