...
Canonical implementation : 03_FUNCTIONS/ceio_evidence_refresh_daemon.py
...
05_ORCHESTRATOR/ceio_evidence_refresh_daemon.py keeps working, while exactly ONE implementation exists.
