...
Canonical implementation : 03_FUNCTIONS/wave17c_promotion_daemon.py
...
05_ORCHESTRATOR/wave17c_promotion_daemon.py keeps working, while exactly ONE implementation exists.
