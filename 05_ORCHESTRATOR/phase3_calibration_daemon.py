...
Canonical implementation : 03_FUNCTIONS/phase3_calibration_daemon.py
...
05_ORCHESTRATOR/phase3_calibration_daemon.py keeps working, while exactly ONE implementation exists.
