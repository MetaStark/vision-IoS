...
Canonical implementation : 03_FUNCTIONS/evidence_unification_daemon.py
...
05_ORCHESTRATOR/evidence_unification_daemon.py keeps working, while exactly ONE implementation exists.
