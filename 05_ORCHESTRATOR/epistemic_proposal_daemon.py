...
Canonical implementation : 03_FUNCTIONS/epistemic_proposal_daemon.py
...
05_ORCHESTRATOR/epistemic_proposal_daemon.py keeps working, while exactly ONE implementation exists.
