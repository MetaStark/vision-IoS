...
Canonical implementation : 03_FUNCTIONS/ceo_gateway_daemon.py
...
05_ORCHESTRATOR/ceo_gateway_daemon.py keeps working, while exactly ONE implementation exists.
