...
Canonical implementation : 03_FUNCTIONS/calendar_integrity_daemon.py
...
05_ORCHESTRATOR/calendar_integrity_daemon.py keeps working, while exactly ONE implementation exists.
