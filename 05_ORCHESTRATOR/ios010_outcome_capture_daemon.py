...
Canonical implementation : 03_FUNCTIONS/ios010_outcome_capture_daemon.py
...
05_ORCHESTRATOR/ios010_outcome_capture_daemon.py keeps working, while exactly ONE implementation exists.
