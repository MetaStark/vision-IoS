...
Canonical implementation : 03_FUNCTIONS/exit_detection_daemon.py
...
05_ORCHESTRATOR/exit_detection_daemon.py keeps working, while exactly ONE implementation exists.
