...
Canonical implementation : 03_FUNCTIONS/ios012b_shadow_signal_daemon.py
...
05_ORCHESTRATOR/ios012b_shadow_signal_daemon.py keeps working, while exactly ONE implementation exists.
