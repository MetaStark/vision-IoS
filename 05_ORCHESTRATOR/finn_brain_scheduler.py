...
Canonical implementation : 03_FUNCTIONS/finn_brain_scheduler.py
...
05_ORCHESTRATOR/finn_brain_scheduler.py keeps working, while exactly ONE implementation exists.
