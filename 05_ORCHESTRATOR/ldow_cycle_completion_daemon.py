...
Canonical implementation : 03_FUNCTIONS/ldow_cycle_completion_daemon.py
...
05_ORCHESTRATOR/ldow_cycle_completion_daemon.py keeps working, while exactly ONE implementation exists.
