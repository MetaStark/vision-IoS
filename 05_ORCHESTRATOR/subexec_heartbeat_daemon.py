...
Canonical implementation : 03_FUNCTIONS/subexec_heartbeat_daemon.py
...
05_ORCHESTRATOR/subexec_heartbeat_daemon.py keeps working, while exactly ONE implementation exists.
