...
Canonical implementation : 03_FUNCTIONS/economic_event_outcome_fetcher.py
...
05_ORCHESTRATOR/economic_event_outcome_fetcher.py keeps working, while exactly ONE implementation exists.
