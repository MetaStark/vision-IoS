...
Canonical implementation : 03_FUNCTIONS/ios003c_shadow_learning_daemon.py
...
05_ORCHESTRATOR/ios003c_shadow_learning_daemon.py keeps working, while exactly ONE implementation exists.
