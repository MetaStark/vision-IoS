...
Canonical implementation : 03_FUNCTIONS/economic_outcome_daemon.py
...
05_ORCHESTRATOR/economic_outcome_daemon.py keeps working, while exactly ONE implementation exists.
