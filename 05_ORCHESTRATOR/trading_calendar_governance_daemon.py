...
Canonical implementation : 03_FUNCTIONS/trading_calendar_governance_daemon.py
...
05_ORCHESTRATOR/trading_calendar_governance_daemon.py keeps working, while exactly ONE implementation exists.
