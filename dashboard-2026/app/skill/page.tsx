...
async function StrategyTile({ strategyId, label, timeframe }: { strategyId: string; label: string; timeframe: string }) {
  ...
  return (
    ...
    console.error(`[STRATEGY-TILE-${label}] Failed:`, msg)
    return <ModuleUnavailable moduleName={`Strategy Tile: ${label}`} error={msg} />
  }
}
...
async function GovernanceTile() {
  ...
  return (
    ...
    const msg = error instanceof Error ? error.message : 'Unknown error'
    console.error('[GOVERNANCE-TILE] Failed:', msg)
    return <ModuleUnavailable moduleName="Governance Tile" error={msg} />
  }
}
...
async function LeaderboardPanel({
  ...
  return (
    ...
    const msg = error instanceof Error ? error.message : 'Unknown error'
    console.error(`[LEADERBOARD-${title}] Failed:`, msg)
    return <ModuleUnavailable moduleName={`Leaderboard: ${title}`} error={msg} />
  }
}
...
async function CalibrationChart({ strategyId, label }: { strategyId: string; label: string }) {
  ...
  return (
    ...
    const msg = error instanceof Error ? error.message : 'Unknown error'
    console.error(`[CALIBRATION-${label}] Failed:`, msg)
    return <ModuleUnavailable moduleName={`Calibration: ${label}`} error={msg} />
  }
}
