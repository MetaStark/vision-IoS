  ...
  return (
    <div className="min-h-screen p-8" style={{ backgroundColor: 'hsl(var(--background))' }}>
      ...
      >
        ...
        <div>
          <p className="font-semibold text-red-400">ZERO Execution Authority</p>
          <p className="text-sm text-red-400/70">
            EC-018 generates hypotheses only. All proposals require G1 review before progression through
            IoS-004 → IoS-008 → IoS-012 pipeline.
          </p>
        </div>
      </div>
      ...
      >
        ...
        >
          <div className="text-xs" style={{ color: 'hsl(var(--muted-foreground))' }}>
            Created: {formatTime(proposal.created_at)} | Expires: {formatTime(proposal.expires_at)}
          </div>
          <div
